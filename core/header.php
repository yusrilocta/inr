...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-white" id="sidenav-main">
   ...
   href="index.php?page=dashboard">
        ...
        <li class="nav-item">
          <a class="nav-link <?= ($current_page == 'pelanggan') ? 'active bg-gradient-primary' : '' ?>" href="index.php?page=pelanggan">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1 nav-link">Pelanggan</span>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link <?= ($current_page == 'barang') ? 'active bg-gradient-primary' : '' ?>" href="index.php?page=barang">
            ...
            <span class="nav-link-text ms-1 nav-link">Barang</span>
                ...
                <li class="nav-item">
          <a class="nav-link <?= ($current_page == 'laporan_perbaikan') ? 'active bg-gradient-primary' : '' ?>" href="index.php?page=laporan_perbaikan">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>customer-support</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1 nav-link">Laporan Perbaikan</span>
          </a>
        </li>
